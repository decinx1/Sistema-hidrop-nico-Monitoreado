...
from PyQt6.QtWidgets import (
    ...
    QSizePolicy, QToolButton, QLabel, QFrame, QScrollArea
)
...
class Sidebar(QWidget):
    ...
    def __init__(
        ...
        expanded_width: int = 240,  # Increased from 180 to 240
        ...
        palette.setColor(QPalette.ColorRole.Window, QColor("#E8F5E9"))  # Fondo verde claro
    ...
    def _setup_header(self, logo_filename):
        """Setup the header with logo and toggle button"""
        header = QWidget()
        header.setObjectName("sidebarHeader")
        header.setMinimumHeight(80)
        
        # Use a more controlled layout for the header
        header_layout = QHBoxLayout(header)
        header_layout.setContentsMargins(16, 16, 16, 16)
        header_layout.setSpacing(10)  # Add spacing between elements
        ...
        self._logo_lbl.setFixedSize(40, 40)  # Fixed size for logo
        ...
        header_layout.addWidget(self._app_name, 1)  # Give it expanding space
        ...
        self._btn_toggle.setFixedSize(32, 32)  # Fixed size for button
    ...
    def _apply_styles(self):
        ...
        # Style for menu buttons - using the button_bg_color for background
        button_style = f"""
            QPushButton {{
    ...
    def toggle(self):
        ...
        anim.setEasingCurve(QEasingCurve.Type.InOutQuint)  # Animación suave
        ...
        # Cambiar tamaño del logo cuando inicia el toggle
